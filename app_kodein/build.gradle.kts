...
dependencies {
    ...
    // kodein
    implementation("org.kodein.di:kodein-di-generic-jvm:${rootProject.extra["kodeinVersion"]}")
    implementation("org.kodein.di:kodein-di-framework-android-x:${rootProject.extra["kodeinVersion"]}")
