                ...
                cameraDevice.createCaptureSession(
                        ...
                        object : CameraCaptureSession.StateCallback() {
                            ...
                            override fun onConfigureFailed(session: CameraCaptureSession) {
                                val errorMessage = "Camera ${cameraDevice.id} createCaptureSession(): onConfigureFailed"
                                Timber.e(errorMessage)
                                continuation.resumeWithException(Error(errorMessage))
                            }
                        },
    ...
    private fun acquireLatestImage(
        ...
        imageReader: ImageReader
            ...
            try {
                ...
                val imageFile: ImageFile = imageRepository.saveImage(image?.planes?.get(0)?.buffer, cameraDevice.id)
                close(cameraDevice)
