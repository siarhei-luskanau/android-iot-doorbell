...
dependencies {
    ...
    implementation(project(":dagger:dagger_permissions"))
    implementation(project(":dagger:dagger_doorbell_list"))
    implementation(project(":dagger:dagger_image_list"))
    implementation(project(":dagger:dagger_image_details"))
