...
class ImageDetailsFragmentTest {
    ...
    fun testNormalState() {
        ...
        Espresso.onView(ViewMatchers.withId(siarhei.luskanau.iot.doorbell.ui.common.R.id.error_message))
            .check(ViewAssertions.doesNotExist())

        scenario.onFragment {
            it.view?.captureRoboImage(filePath = "screenshots/ImageDetailsFragment.normal.png")
        }
    }
    ...
    fun testErrorState() {
        ...
        scenario.onFragment {
            it.view?.captureRoboImage(filePath = "screenshots/ImageDetailsFragment.empty.png")
        }
    }
}
